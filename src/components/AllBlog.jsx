...
export const AllBlog = () => {
  ...
  return (
    <div className="mt-[100px] max-w-screen-xl">
      ...
      <button className="hidden md:w-[123px] h-[48px] border-[1px] border-solid  rounded-[6px] mt-[100px] ml-[600px] text-base font-semibold text-gray-500 workSansText mb-[100px]">
        Load More
      </button>
    </div>
  );
